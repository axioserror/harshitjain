  ...
  return (
   ...
   <div className='font-poppins text-2xl font-light'>project name</div>
      <div>
        ...
        {techStack && techStack.map((techStack, i) => <li key={i} className='bg-white rounded-md p-1 text-sm '> 
         {techStack}</li>)}</ul>
          </div>
   </div>
   <div className='w-full '>
    <p className='border-2 border-white rounded-lg p-2 mt-2 '> Lorem ipsum dolor sit amet. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure assumenda aut laboriosam sint temporibus molestias necessitatibus rerum voluptate, natus velit nisi at tempore repellat, aliquam sit quaerat sapiente quas! Hic nesciunt at, voluptate officia ullam nobis ad voluptatibus porro minus in eaque. Iure, esse explicabo </p>
