    ...
    >
      ...
      <div className="relative z-10 min-h-screen p-4 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-4 md:col-start-9 md:row-start-2 bg-black p-4 md:p-8">
            ...
            <div className="space-y-2 flex flex-col md:flex-row gap-4">
              <button className='w-full md:w-2/3 border border-white px-4 py-2 hover:bg-white hover:text-black transition-colors text-center text-sm md:text-base'>
                <a
                  href={resumePDF}
                  target="_blank"
